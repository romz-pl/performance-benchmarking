...
+ [Analyze system behavior](./doc/system-behavior.md)
+ [Partner with architecture](./doc/partner-architecture.md)
+ [Within the first 3 months](./doc/months-3.md)
+ [Within the first 6 months](./doc/months-6.md)
+ [Within the first 12 months](./doc/months-12.md)


## Preferred Experience
+ [Experience with Python, C++, or C#](./doc/python.md)
+ [Background in system performance analysis](./doc/system-performance.md)
+ [Familiarity with SIMD or vectorization concepts](./doc/vectorization-concepts.md)
+ [Experience designing automation frameworks](./doc/automation-frameworks.md)
+ [Exposure to cross-platform development](./doc/cross-platform.md)
+ [Understanding of system architecture](./doc/system-architecture.md)
+ [Experience with concurrent programming](./doc/concurrent-programming.md)
